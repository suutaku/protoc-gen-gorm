...
protoc-gen-gorm is a fork from `github.com/infobloxopen/protoc-gen-gorm`. 
at v0.0.1 
- fix bugs at code generation.
- update dependency to the latest version.
- use `go build` to build this project instead of `dep`.
...
To use this tool, install it from code with `go build`, `go install` directly,
or `go get github.com/suutaku/protoc-gen-gorm`.
