...
import types1 "github.com/suutaku/protoc-gen-gorm/types"

import math "math"
import google_protobuf1 "github.com/golang/protobuf/ptypes/wrappers"
import _ "github.com/golang/protobuf/ptypes/empty"
import _ "github.com/golang/protobuf/ptypes/timestamp"
import user "github.com/suutaku/protoc-gen-gorm/example/user"
...
func DefaultReadTestAssocHandlerDefault(ctx context.Context, in *TestAssocHandlerDefault, db *gorm1.DB) (*TestAssocHandlerDefault, error) {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, nil, &TestAssocHandlerDefaultORM{}); err != nil {
		return nil, err
	}
...
func DefaultListTestAssocHandlerDefault(ctx context.Context, db *gorm1.DB) ([]*TestAssocHandlerDefault, error) {
	...
	db, err = gorm2.ApplyCollectionOperators(ctx, db, &TestAssocHandlerDefaultORM{}, &TestAssocHandlerDefault{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadTestAssocHandlerReplace(ctx context.Context, in *TestAssocHandlerReplace, db *gorm1.DB) (*TestAssocHandlerReplace, error) {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, nil, &TestAssocHandlerReplaceORM{}); err != nil {
		return nil, err
	}
...
func DefaultListTestAssocHandlerReplace(ctx context.Context, db *gorm1.DB) ([]*TestAssocHandlerReplace, error) {
	...
	db, err = gorm2.ApplyCollectionOperators(ctx, db, &TestAssocHandlerReplaceORM{}, &TestAssocHandlerReplace{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadTestAssocHandlerClear(ctx context.Context, in *TestAssocHandlerClear, db *gorm1.DB) (*TestAssocHandlerClear, error) {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, nil, &TestAssocHandlerClearORM{}); err != nil {
		return nil, err
	}
...
func DefaultListTestAssocHandlerClear(ctx context.Context, db *gorm1.DB) ([]*TestAssocHandlerClear, error) {
	...
	db, err = gorm2.ApplyCollectionOperators(ctx, db, &TestAssocHandlerClearORM{}, &TestAssocHandlerClear{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadTestAssocHandlerAppend(ctx context.Context, in *TestAssocHandlerAppend, db *gorm1.DB) (*TestAssocHandlerAppend, error) {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, nil, &TestAssocHandlerAppendORM{}); err != nil {
		return nil, err
	}
...
func DefaultListTestAssocHandlerAppend(ctx context.Context, db *gorm1.DB) ([]*TestAssocHandlerAppend, error) {
	...
	db, err = gorm2.ApplyCollectionOperators(ctx, db, &TestAssocHandlerAppendORM{}, &TestAssocHandlerAppend{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
